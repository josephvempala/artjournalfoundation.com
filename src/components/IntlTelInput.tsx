...
const countries = [
  ...
  { name: "Congo, Democratic Republic of", code: "+243", flag: "🇨🇩" },
  { name: "Congo, Republic of", code: "+242", flag: "🇨🇬" },
...
const IntlTelInput = () => {
  ...
  const handleCountryChange = (countryCode: string) => {
    ...
    // reset but preserve any number after previous code
  ...
  const onChangeHandler = (e: ChangeEvent<HTMLInputElement>) => {
    ...
    // If user tries to delete or edit the country code, restore it
    if (!val.startsWith(selectedCountry)) {
      setPhone(selectedCountry + " " + val.replace(/[^0-9]/g, ""));
      return;
    }
