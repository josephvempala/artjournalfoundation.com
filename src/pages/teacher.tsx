              ...
              <div className="services-two__single">
                <div className="services-two__img-box">
                  <div className="services-two__img">
                    <Image
                      ...
                      alt="teacher-student-art-support"
                      width={370}
                      height={270}
                    />
                  </div>
                ...
                <div className="services-two__content">
                  <h3 className="services-two__title">
                    <Link prefetch={false} href="/teacher/art-support">
                      I want to mentor students for Arts (Visual
                      Arts/Dance/Theatre/Music)
                    </Link>
                  </h3>
                  <p className="services-two__text">
                    Wish to enroll as a mentor to support students for enhancing
                    skills/ reviewing submissions.
                  </p>
                  <Link
                    prefetch={false}
                    href="/teacher/art-support"
              ...
              <div className="services-two__single">
                <div className="services-two__img-box">
                  <div className="services-two__img">
                    <Image
                      src="/assets/images/home/teacher.webp"
                      alt="teacher-student-art-article"
                      width={370}
                      height={270}
                    />
                  </div>
                ...
                <div className="services-two__content">
                  <h3 className="services-two__title">
                    <Link prefetch={false} href="/teacher/art-article">
...
export default withLayout(TeacherPage);
