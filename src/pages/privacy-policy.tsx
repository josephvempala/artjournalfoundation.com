                          ...
                          <div className="wpo-case-content">
                            <div className="wpo-case-text-top">
                              ...
                              <div className="case-b-text">
                                <p>
                                  This document lays out the Privacy Policy
                                  which shall be applicable to Art Journal
                                  Foundation, the brand name of Elevating Art
                                  Private Limited (hereinafter to be referred to
                                  as Company). The word User refers to the
                                  person who can access the Art Journal
                                  Foundation website, owned by the Company, and
                                  shall include both singular and plural.
                                  Reference to masculine shall include the
                              ...
                              <div className="case-bb-text">
                                ...
                                <p>
                                  1. By using the website or services, the User
                                  authorizes the Company to use the User’s
                                  information.{" "}
                                </p>
                                <p>
                                  1.2. Information that is collected or
                                ...
                                <p>
                                  1.3 How the User’s personal information is
                                ...
                                <p>
                                  1.4. How can the User protect his privacy:
                                ...
                                <p>
                                  1.5. If the User believes that there has been
                                  ...
                                  <a href="mail:artjournalfoundation@gmail.com">
                                ...
                                <p>
                                  1.6. In case of any request to access and
                                ...
                                <p>
                                  1.7. Any and all access to third-party
                                ...
                                <p>
                                  1.8. No fiduciary relationship has been
                              ...
                              <div className="case-bb-text">
                                <h3>
                                  2. Online order process and formation of
                                  contract{" "}
                                </h3>
                                <p>
                                  2.1. The contract between the Company and the
                                ...
                                <ul>
                                  <li>
                                    ...
                                    subscriptions/ paid service. The User’s data
                                    will be treated by the Company in accordance
                                    with the aforementioned Privacy Policy.{" "}
                                  </li>
                                  <li>
                                ...
                                <p>
                                  2.2. Cancellation for any subscription
